...
ROOT_URLCONF = 'interpreteer.urls'
...
TEMPLATE_DIRS = (
    ...
    os.path.join(PROJECT_ROOT, 'frontend/django_templates'),
)
...
DEBUG_TOOLBAR_CONFIG = {
    ...
    'SHOW_TOOLBAR_CALLBACK': 'interpreteer.settings.base.custom_show_toolbar',
...
SYSTEM_EMAIL_PREFIX = "[interpreteer]"

## Log settings

LOG_LEVEL = logging.INFO
HAS_SYSLOG = True
SYSLOG_TAG = "http_app_interpreteer"  # Make this unique to your project.
