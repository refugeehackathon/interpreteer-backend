"""
Starter fabfile for deploying the interpreteer project.
...
# CHANGEME
env.hosts = ['user@interpreteer.example.com']
env.code_dir = '/srv/www/interpreteer'
env.project_dir = '/srv/www/interpreteer/interpreteer'
env.static_root = '/srv/www/interpreteer/static/'
env.virtualenv = '/srv/www/interpreteer/.virtualenv'
env.code_repo = 'git@github.com:user/interpreteer.git'
env.django_settings_module = 'interpreteer.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/interpreteer/wsgi.py" % env.code_dir)
